...
\begin{frame}{Divide and Conquer}
    \centering
    \includegraphics[width=.95\linewidth]{a.PNG}
\end{frame}
\begin{frame}{Divide and Conquer}
    \centering
    \includegraphics[width=.7\linewidth]{a0.PNG}
\end{frame}
\begin{frame}{Divide and Conquer}
    \centering
    \includegraphics[width=.7\linewidth]{a1.PNG}
\end{frame}
\begin{frame}{Divide and Conquer}
    \centering
    \includegraphics[width=.7\linewidth]{a2.PNG}
\end{frame}
\begin{frame}{Divide and Conquer}
    \centering
